  ...
  const features = [
    {
      ...
      copy:
        "End-to-end fire protection solutions including extinguishers, hydrants, sprinklers and suppression systems, designed around your property's specific needs.",
    },
    {
      icon: "fa-solid fa-bell",
      title: "Early Detection & Alarm",
      copy:
        "Advanced fire detection and alarm systems designed to identify hazards early, deliver timely alerts and support a rapid emergency response.",
    },
    {
      icon: "fa-solid fa-screwdriver-wrench",
      title: "Installation, Testing & AMC",
      copy:
        "Professional installation, testing, commissioning and preventive maintenance to keep your fire safety systems reliable, compliant and ready.",
    },
  ];

  // GitHub Pages compatible image path
  const aboutImage = `${import.meta.env.BASE_URL}images/about_img.png`;
